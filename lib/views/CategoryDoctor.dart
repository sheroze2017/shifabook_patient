    ...
    return Scaffold(
      ...
      body: Obx(() => ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              var exp = doctorController
                  .accountData!.data![index].doctorUser!.yearsOfExperience;
              var onlinefees = doctorController
                  .accountData!.data![index].doctorUser!.onlineConsultationFee;
              var onsitefees = doctorController
                  .accountData!.data![index].doctorUser!.onsiteConsultationFee;
